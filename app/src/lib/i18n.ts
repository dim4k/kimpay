...
export const locales = {
  en: {
    ...
    "settings.export.desc": "Download a summary of this Kimpay including all expenses and participants.",
  ...
  fr: {
    ...
    "settings.export.desc": "Téléchargez un résumé de ce Kimpay incluant toutes les dépenses et les participants.",
    "settings.export.csv": "CSV",
    "settings.export.md": "Markdown",
    "export.col.date": "Date",
    "export.col.desc": "Description",
