...
export const locales = {
  en: {
    ...
    "home.create.email_help": "Leave your email to receive the Kimpay link (useful if you lose access).",
    ...
    "modal.leave.desc": "Are you sure you want to remove this group from your recent list? This will also remove you as a participant.",
    "modal.leave.confirm": "Leave",
    
    "modal.delete_expense.title": "Delete Expense?",
    "modal.delete_expense.desc": "This will permanently remove this expense from the group.",
    ...
    "modal.delete_participant.confirm": "Are you sure you want to delete this participant?",
    "error.participant.used": "Cannot delete: This participant is part of existing expenses.",
    ...
    "settings.switch_modal.desc": "Are you sure you want to switch to this identity?",
    ...
    "settings.actions.remove_desc": "Remove this group from your recent list on this device.",
    "settings.actions.delete_desc": "Permanently delete this group and all its data for everyone.",
    "settings.actions.delete_warning": "WARNING: This will permanently delete the group, all expenses, and all data for EVERYONE. This action cannot be undone.",
    ...
    "error.404.desc": "Looks like you've drifted into deep space. This page doesn't exist.",
  ...
  fr: {
    ...
    "home.create.email_help": "Laissez votre email pour recevoir le lien du Kimpay (utile si vous perdez l'accès).",
    ...
    "modal.leave.desc": "Voulez-vous vraiment retirer ce groupe de votre liste ? Cela vous retirera également des participants.",
    "modal.leave.confirm": "Quitter",
    
    "modal.delete_expense.title": "Supprimer la dépense ?",
    "modal.delete_expense.desc": "Cela supprimera définitivement cette dépense du groupe.",
    ...
    "modal.delete_participant.confirm": "Voulez-vous vraiment supprimer ce participant ?",
    "error.participant.used": "Impossible de supprimer : ce participant est lié à des dépenses existantes.",
    ...
    "settings.switch_modal.desc": "Voulez-vous vraiment changer d'identité pour ce participant ?",
    ...
    "settings.actions.title": "Actions",
    "settings.actions.remove_desc": "Retirer ce groupe de votre liste récente sur cet appareil.",
    "settings.actions.delete_desc": "Supprimer définitivement ce groupe et toutes ses données pour tout le monde.",
    "settings.actions.delete_warning": "ATTENTION : Cela supprimera définitivement le groupe, toutes les dépenses et toutes les données pour TOUT LE MONDE. Cette action est irréversible.",
    ...
    "balance.empty.desc": "Ajoutez des dépenses pour voir comment les partager.",
    "balance.settled.title": "Tout est réglé !",
    "balance.settled.desc": "Parfaitement équilibré. Comme toutes choses devraient l'être.",
    ...
    "error.404.desc": "On dirait que vous êtes perdu dans l'hyper-espace. Cette page n'existe pas.",
...
export const t = derived(locale, ($locale) => (key: string, vars: Record<string, string> = {}) => {
  const dictionary = locales as Record<string, Record<string, string>>;
