...
<div class="text-center space-y-2 md:space-y-4 mb-6 md:mb-10 animate-slide-up">
    ...
    <h1 class="text-2xl md:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-indigo-600 via-blue-500 to-cyan-500 dark:from-indigo-400 dark:via-blue-400 dark:to-cyan-400 bg-clip-text text-transparent">{$t('app.name')}</h1>
